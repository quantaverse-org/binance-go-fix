...
type SelfTradePreventionModeEnum byte
type SelfTradePreventionModeValues struct {
	...
	Transfer         SelfTradePreventionModeEnum
	NonRepresentable SelfTradePreventionModeEnum
	NullValue        SelfTradePreventionModeEnum
}

var SelfTradePreventionMode = SelfTradePreventionModeValues{49, 50, 51, 52, 53, 54, 126, 0}
...
func (*SelfTradePreventionModeEnum) TransferSinceVersion() uint16 {
	return 0
}

func (s *SelfTradePreventionModeEnum) TransferInActingVersion(actingVersion uint16) bool {
	return actingVersion >= s.TransferSinceVersion()
}

func (*SelfTradePreventionModeEnum) TransferDeprecated() uint16 {
	return 0
}
